...
export function Banner() {
  return (
    <Anuncio>
      <AnuncioContenido>
        <AnuncioDescripcion>
          <AnuncioTitulo>Desafio React</AnuncioTitulo>
          <AnuncioDetalle>
            Este desafío es tu oportunidad de poner en práctica todo lo que has
            aprendido sobre React. Al resolver un problema real, consolidarás
            tus conocimientos y darás un gran paso en tu crecimiento como
            desarrollador.
          </AnuncioDetalle>
